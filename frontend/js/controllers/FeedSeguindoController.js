angular.module("amigoApp").controller("FeedSeguindoController", function ($scope, FeedService, LoginService, $location, $modal, $timeout, $window) {
  $scope.posts = [];
  $scope.pagina = 1;
  ...
  $scope.listaPosts = function (pagina) {
    ...
    FeedService.getPostsDosSeguidores(pagina || 1)
